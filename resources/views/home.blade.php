        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="col-sm-4">
                        <img alt="profil.png" src="{{Auth::user()->photo?asset('images/upload/'.Auth::user()->photo->file)
                            :'http://image.flaticon.com/icons/svg/38/38808.svg'}}" class="img img-responsive">
                    </div>
                    <div class="col-md-8">
